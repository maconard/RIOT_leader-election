...
char neighbors[20][16];
int negihbors_val[20] = { 0 };
...
void *_udp_server(void *args)
{
    ...
    ipv6_addr_to_str(my_ipv6,(ipv6_addr_t*)&server.addr,16);
    printf("My ipv6: %s", my_ipv6);
    //ipv6_addr_print((ipv6_addr_t*)&server.addr);
